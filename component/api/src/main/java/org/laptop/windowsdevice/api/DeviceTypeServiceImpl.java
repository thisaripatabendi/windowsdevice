...
package org.laptop.windowsdevice.api;

import org.laptop.windowsdevice.api.dto.DeviceJSON;
import org.laptop.windowsdevice.api.dto.SensorRecord;
import org.laptop.windowsdevice.api.util.APIUtil;
import org.laptop.windowsdevice.api.util.ZipUtil;
import org.laptop.windowsdevice.api.util.ZipArchive;
import org.laptop.windowsdevice.plugin.constants.DeviceTypeConstants;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "windowsdevice"));
            APIUtil.getDeviceManagementService().addOperation("windowsdevice", commandOp,
                                                              deviceIdentifiers);
