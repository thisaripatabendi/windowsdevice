...
package org.laptop.windowsdevice.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "windowsdevice";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "windowsdevice_DEVICE_ID";
...
//    public static final String SENSOR_TYPE3_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_windowscpuusage";
    ...
    public static final String SENSOR_TYPE6_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_WINDOWSLOADAVERAGE";
    ...
    public final static String SENSOR_TYPE6 = "windowsloadaverage";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/windowsdevice/+/windowsbatterylevel";
