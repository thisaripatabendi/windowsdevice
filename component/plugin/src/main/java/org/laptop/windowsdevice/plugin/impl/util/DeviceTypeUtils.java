...
package org.laptop.windowsdevice.plugin.impl.util;
...
/**
 * Contains utility methods used by windowsdevice plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.laptop.windowsdevice.plugin.impl.util.DeviceTypeUtils.class);
